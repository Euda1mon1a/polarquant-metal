...
KV cache bits are now selected adaptively from vm.memory_pressure:
    normal   → FP16   warn → 4-bit K/V   critical → 3-bit K / 4-bit V

Usage:
    python scripts/serve_72b.py
    python scripts/serve_72b.py --no-draft --port 8083
    python scripts/serve_72b.py --hysteresis 10 --poll-interval 3
"""
...
def main():
    ...
    from polarquant_metal.memory_monitor import start_monitor
    ...
    print(f"  bits        : adaptive (vm.memory_pressure)")
